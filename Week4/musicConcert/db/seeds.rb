...
Concert.create!(artist: 'Meek Mill', venue: 'Barclay\'s Center', city: 'New York City', 
	date: '09/16/2016', price: '$5', description: 'I don\'t know why anyone would want to come, but hey, if you want to, come.')

Concert.create!(artist: 'Drake', venue: 'Rupp Arena', city: 'Lexington', 
	date: Time.now, price: '$280', description: 'Drake is back again with his serenading voice.')
